...
const products = [
  ...
  { id: 3, name: "Frango frito", cod: 13, valor: '99,99', img: 'https://unsplash.com/photos/RWAToPPP9RY/download?ixid=M3wxMjA3fDB8MXxzZWFyY2h8Mnx8ZnJhbmdvJTIwZnJpdG98cHR8MHx8fHwxNzEwNTIxNDk5fDA&force=true&w=640' },
  { id: 4, name: "Camarão", cod: 14, valor: '99,99', img: 'https://unsplash.com/photos/4LoGKVmUJsI/download?ixid=M3wxMjA3fDB8MXxzZWFyY2h8NHx8Y2FtYXIlQzMlQTNvfHB0fDB8fHx8MTcxMDUyMTUzMnww&force=true&w=640' },
  { id: 5, name: "Coca-cola", cod: 15, valor: '99,99', img: 'https://unsplash.com/photos/z8PEoNIlGlg/download?ixid=M3wxMjA3fDB8MXxhbGx8fHx8fHx8fHwxNzEwNTIxNTYzfA&force=true&w=640' },
